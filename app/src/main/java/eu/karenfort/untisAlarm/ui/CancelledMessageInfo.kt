...
class CancelledMessageInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //TODO: implement that lessons with messages that have "Tasks(Aufgaben)"
        // or "Cancelled(Ausfall)" in them are shown
        // and the user can check if they are actually cancelled
    }
}